...
if ( ! function_exists( 'uxb_port_load_frontend_scripts' ) ) {
	...
	function uxb_port_load_frontend_scripts() {
		...
		wp_register_script( 'uxbarn-imagesloaded', UXB_PORT_URL . 'js/imagesloaded.pkgd.min.js', array( 'jquery' ), null, true ); // named the handle as same as the theme's
	    wp_register_script( 'uxbarn-isotope', UXB_PORT_URL . 'js/isotope.pkgd.min.js', array( 'jquery', 'uxbarn-imagesloaded' ), null, true ); // named the handle as same as the theme's
