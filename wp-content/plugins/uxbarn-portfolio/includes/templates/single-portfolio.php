...
<?php if ( is_plugin_active( 'option-tree/ot-loader.php' ) ) : ?>
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
	    ...
	    <?php if ( $display_post_format_content ) : ?>
	        ...
	        <?php if ( $post_format == 'image-slideshow' ) : ?>
	            ...
	            <div id="uxb-port-images-type" class="row <?php echo esc_attr( $hide_images_div_class ); ?>">
	                <div class="uxb-col <?php echo esc_attr( $layout_images_column ); ?> columns">
		                        ...
		                        <?php foreach ( $images as $image ) : ?>
		                            ...
		                            <?php if ( $image_full_size_url ) : ?>
			                            ...
			                            <li class="uxb-port-single-image">
			                                <a href="<?php echo esc_url( $image_full_size_url ); ?>" class="uxb-port-image-box" title="<?php echo esc_attr( $title ); ?>" data-fancybox-group="portfolio-image-group"><img src="<?php echo esc_url( $image_display_size_url ); ?>" alt="<?php echo esc_attr( $alt ); ?>" width="<?php echo intval( $image_width ); ?>" height="<?php echo intval( $image_height ); ?>" class="border" /></a>
		...
		<?php endif; ?>
	        ...
	        <div class="uxb-col <?php echo esc_attr( $layout_info_column ); ?> columns">
		        ...
		        <div class="row <?php if ( uxb_port_is_using_vc() ) echo ' no-margin-bottom '; ?>">
		        	...
		        	<?php if ( $show_meta == 'true' ) : ?>
		        		...
		        		<div class="uxb-col <?php echo esc_attr( $layout_meta_columns . $layout_meta_columns_push ); ?> columns">
	        				...
	        				<?php else : // Default meta info ?>
				                ...
				                <ul id="uxb-port-item-meta" class="<?php echo esc_attr( $meta_class ); ?>">
				                    <li>
				                        <strong class="title"><?php _e( 'Date', 'uxb_port' ); ?></strong><?php echo esc_html( $meta_date ); ?>
				                    </li>
				                    <li>
				                        <strong class="title"><?php _e( 'Client', 'uxb_port' ); ?></strong><?php echo esc_html( $meta_client ); ?>
				                    </li>
		        	...
		        	<div class="uxb-col <?php echo esc_attr( $layout_content_columns . $layout_content_columns_pull ); ?> columns">
