...
?>
		...
		<p>
			...
			<br/>
			<em>(<?php echo __('Don\'t know your ID?', 'uxbarn') . ' <a href="//idgettr.com/" target="_blank">' . __('Click here', 'uxbarn') . '</a>'; ?>)</em>
...
<?php
	...
	public function widget($args, $instance) {
		...
		echo '<script type="text/javascript" src="//www.flickr.com/badge_code_v2.gne?show_name=1&count=' . $photo_amount . '&display=' . $display . '&size=s&layout=x&source=user&user=' . $flickr_id . '"></script>';
